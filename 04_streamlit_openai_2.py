...
assistant_id = 'asst_03kNVCEOyJA4A2vUIyCL31HR'
#thread_id = 'thread_4lOiC1dZRRM8VZBcBG7cCyOX'

with st. sidebar:
    openai_api_key = st.text_input("OpenAI API KEY",type="password")

    iframe_html ="""<iframe src="https://ads-partners.coupang.com/widgets.html?id=770704&template=banner&trackingCode=AF1614696&subId=&width=300&height=250" width="300" height="250" frameborder="0" scrolling="no" referrerpolicy="unsafe-url" browsingtopics></iframe>"""
    ...
    thread_id = st.text_input("Thread ID", value='thread_4lOiC1dZRRM8VZBcBG7cCyOX')
